...
import ResourceForm from '@glugox/module/components/ResourceForm.vue';
import DialogManager from '@glugox/module/components/DialogManager.vue';
import {Entity, DbId, Relation, ResourceFormProps} from '@glugox/module/types/support';
import { useEntityEvents } from '@glugox/module/composables/useEntityEvents';
